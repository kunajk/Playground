...
void APuzzlePlatformsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Toggle_InGameMenu", IE_Pressed, this, &APuzzlePlatformsCharacter::OpenInGameMenu);
...
{
	UPGameInstance* aPGameInstance = Cast<UPGameInstance>(this->GetGameInstance());
	if (!ensure(aPGameInstance != nullptr)) return;
	aPGameInstance->ToggleInGameMenu();
}
